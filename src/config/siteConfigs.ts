export interface Field {
  key: string;
  type: 'text' | 'textarea' | 'image' | 'array' | 'object' | 'number' | 'date' | 'select' | 'boolean' | 'file' | 'longtext' | 'richtext' | 'string_array';
  label: string;
...
export interface Section {
  ...
  isHidden?: boolean;
  isCloned?: boolean;
  /** Set on cloned sections so a clone-of-a-clone still points at the original. */
  originalSectionId?: string;
  newUrlSlug?: string;
  /** Public URL path this section renders on, e.g. "/auditorium". */
  path?: string;
  /** Plain-English note shown above the fields. */
  help?: string;
}
...
export interface Page {
  ...
  title: string;
  sections: Section[];
  /** Public URL path this group of sections appears on, e.g. "/about". */
  path?: string;
  /** One-line explanation shown at the top of the editor. */
  description?: string;
}
...
export interface SiteConfig {
  ...
  baseUrl: string;
  pages: Page[];
  /** Public origin of the live website, used for "view live page" links. */
  siteUrl?: string;
}

/**
 * The five campus-life pages share one document shape (see
 * ishan-backend/models/campusLifeSchema.js). This builds the editor fields for
 * one of them so the sections stay identical across sites.
 */
const campusLifeFields = (key: string, label: string): Field[] => ([
  {
    key, type: 'object', label,
    fields: [
      { key: 'title', type: 'text', label: 'Page Title (shown in the banner)' },
      { key: 'subtitle', type: 'text', label: 'Page Subtitle (shown under the title)' },
      { key: 'heading', type: 'text', label: 'Section Heading' },
      { key: 'content', type: 'richtext', label: 'Main Content' },
      { key: 'bannerImage', type: 'image', label: 'Feature Image' },
      { key: 'badge', type: 'text', label: 'Badge over the image (optional, e.g. "ANNUAL SPORTS MEET")' },
      {
        key: 'images', type: 'array', label: 'Photo Gallery — add as many photos as you like; the page layout adapts',
        fields: [
      ...
      {
        key: 'specs', type: 'array', label: 'Key Facts (shown as small cards)',
        fields: [
          { key: 'label', type: 'text', label: 'Label (e.g. Seating)' },
          { key: 'value', type: 'text', label: 'Value (e.g. 500+ seats)' },
        ],
      },
      {
        key: 'notes', type: 'object', label: 'Notes / Rules Box (optional)',
        fields: [
          { key: 'title', type: 'text', label: 'Box Title (e.g. Lab Rules)' },
          { key: 'items', type: 'string_array', label: 'Bullet Points' },
        ],
      },
    ],
  },
...
const campusLifePage = (): Page => ({
  id: 'campus_life',
  title: 'Campus Life',
  description: 'Auditorium, sports, library, research lab and cultural activities. Each section controls one page end to end — banner, copy, photos and key facts.',
  sections: [
    { id: 'campus_auditorium', title: 'Auditorium', endpoint: 'campuslife', type: 'singleton', path: '/auditorium', fields: campusLifeFields('auditorium', 'Auditorium Page') },
    { id: 'campus_sports', title: 'Sports', endpoint: 'campuslife', type: 'singleton', path: '/sports', fields: campusLifeFields('sports', 'Sports Page') },
    { id: 'campus_library', title: 'Library', endpoint: 'campuslife', type: 'singleton', path: '/library', fields: campusLifeFields('library', 'Library Page') },
    { id: 'campus_it_lab', title: 'Research / IT Lab', endpoint: 'campuslife', type: 'singleton', path: '/it-lab', fields: campusLifeFields('itLab', 'Research Lab Page') },
    { id: 'campus_cultural', title: 'Cultural Activities', endpoint: 'campuslife', type: 'singleton', path: '/cultural-activities', fields: campusLifeFields('culturalActivities', 'Cultural Activities Page') },
  ],
});
...
export const siteConfigs: Record<string, SiteConfig> = {
    ...
    pages: [
        ...
        sections: [
          ...
          },
          {
            id: "stand_apart", title: "What Makes IIMT Stand Apart", endpoint: "homepage", type: "singleton", fields: [
              { key: "standApart", type: "object", label: "Content", fields: [{ key: "description", type: "textarea", label: "Description" }, { key: "points", type: "array", label: "Feature Points", fields: [{key: "title", type: "text", label: "Title"}, {key: "text", type: "text", label: "Subtext / Description"}, {key: "icon", type: "text", label: "Icon Name (e.g. Award)"}] }, { key: "cta", type: "text", label: "CTA Text" }] }]
          },
          {
          ...
          },
          {
            id: "success_stories", title: "Success Stories", endpoint: "homepage", type: "singleton", fields: [
              { key: "successStories", type: "object", label: "Stories", fields: [{ key: "students", type: "array", label: "Student Feedback", fields: ["name", { key: "photo", type: "image", label: "Photo" }, "feedback"] }, { key: "parents", type: "array", label: "Parent Feedback", fields: ["name", { key: "photo", type: "image", label: "Photo" }, "feedback"] }] }]
          },
          {
            id: "faqs", title: "Frequently Asked Questions", endpoint: "homepage", type: "singleton", fields: [
              { key: "faqs", type: "array", label: "FAQs", fields: [{key: "question", type: "text", label: "Question"}, {key: "answer", type: "textarea", label: "Answer"}] }
            ]
          },
          {
        ...
        sections: [
          {
            id: "about_iimt", title: "About IIMT Content", endpoint: "aboutus", type: "singleton", fields: [
              { key: "ourStory", type: "object", label: "Our Story", fields: [{ key: "image", type: "image", label: "Image" }, { key: "bannerImage", type: "image", label: "Banner Image" }, { key: "editorialPhotos", type: "array", label: "Editorial Photos", fields: [{ key: "url", type: "image", label: "Image" }] }, { key: "timelineInfographic", type: "image", label: "Timeline Infographic (Single Image)" }, { key: "timelineImages", type: "array", label: "Timeline Infographics (Multiple Images)", fields: [{ key: "url", type: "image", label: "Image" }] }, "description"] }, { key: "ourJourney", type: "array", label: "Our Journey (Milestones)", fields: ["year", "event"] }, { key: "keyDifferentiators", type: "array", label: "Key Differentiators", fields: ["title", "description"] }]
          },
          {
            id: "director_message", title: "Director's Message", endpoint: "aboutus", type: "singleton", path: "/director-message", fields: [
          ...
          {
            id: "vision_mission", title: "Mission & Vision", endpoint: "aboutus", type: "singleton", path: "/mission-vision", fields: [
          ...
          {
            id: "approvals", title: "Approvals & Affiliations", endpoint: "aboutus", type: "singleton", path: "/approvals", fields: [
          ...
          {
            id: "why_iimt", title: "Why IIMT?", endpoint: "aboutus", type: "singleton", path: "/why-iimt", fields: [
          ...
          {
            id: "best_practices", title: "Best Practices", endpoint: "aboutus", type: "singleton", path: "/best-practices", fields: [
          ...
          {
            id: "green_initiatives", title: "Green Initiatives", endpoint: "aboutus", type: "singleton", path: "/green-initiatives", fields: [
          ...
          {
            id: "mandatory_disclosure", title: "Mandatory Disclosure", endpoint: "aboutus", type: "singleton", path: "/mandatory-disclosure", fields: [
          ...
          {
            id: "research_journal", title: "Research Journal", endpoint: "aboutus", type: "singleton", path: "/research-journal", fields: [
          ...
          // --- Redirections for DRY Principle (Navbar Mirror) ---
          {
            id: "redir_faculty", title: "Faculty Directory", endpoint: "", type: "singleton", fields: [],
            redirect: { targetPage: "campus_life", targetSection: "faculty", message: "Manage Faculty Directory in the Campus Life section." }
          },
          {
            id: "redir_visiting", title: "Visiting Faculty", endpoint: "", type: "singleton", fields: [],
            redirect: { targetPage: "campus_life", targetSection: "visiting_faculty", message: "Manage Visiting Faculty in the Campus Life section." }
          },
          {
            id: "redir_faqs", title: "FAQs", endpoint: "", type: "singleton", fields: [],
            redirect: { targetPage: "admissions", targetSection: "faqs", message: "Manage FAQs in the Admissions section." }
          },
          {
            id: "redir_placements", title: "Placement Overview", endpoint: "", type: "singleton", fields: [],
            redirect: { targetPage: "placements", targetSection: "placement_headings", message: "Manage Placements Overview in the Placements section." }
          },
          {
            id: "redir_testimonials", title: "Placement Testimonials", endpoint: "", type: "singleton", fields: [],
            redirect: { targetPage: "placements", targetSection: "stories", message: "Manage Placement Testimonials in the Placements section." }
          },
          {
            id: "redir_alumni", title: "Alumni Network", endpoint: "", type: "singleton", fields: [],
            redirect: { targetPage: "placements", targetSection: "e_cell", message: "Manage Alumni Network (Spotlight) in the E-Cell & Internships section." }
          },
          {
            id: "redir_ecell", title: "Entrepreneurship Cell", endpoint: "", type: "singleton", fields: [],
            redirect: { targetPage: "placements", targetSection: "e_cell", message: "Manage E-Cell in the Placements section." }
          }
        ]
      },
      {
        id: "courses", title: "Courses", sections: [{
          id: "courses_list", title: "Course Catalog", endpoint: "courses", type: "collection", fields: [
            { key: "programName", type: "text", label: "Program Name" }, { key: "overview", type: "richtext", label: "Program Overview" }, { key: "homepageSummary", type: "textarea", label: "Summary on Homepage" }, { key: "curriculumStructure", type: "richtext", label: "Curriculum Structure" }, { key: "careerScope", type: "richtext", label: "Career Scope" }, { key: "quickFacts", type: "textarea", label: "Quick Facts" }, { key: "careerOutcome", type: "textarea", label: "Career Outcome (Homepage)" }, { key: "duration", type: "text", label: "Duration" }, { key: "annualFee", type: "text", label: "Annual Fee" }, { key: "annualIntake", type: "text", label: "Annual Intake" }, { key: "eligibility", type: "textarea", label: "Eligibility" }, { key: "slug", type: "text", label: "Slug" }, { key: "bannerImage", type: "image", label: "Banner Image" }, { key: "images", type: "array", label: "Campus Experience Images (Max 3)", fields: [{ key: "url", type: "image", label: "Image URL" }] }, { key: "studentActivityImages", type: "array", label: "Student Activity Images", fields: [{ key: "url", type: "image", label: "Image" }] }, { key: "placementOutcomeImage", type: "image", label: "Placement Outcome Image" }, { key: "facultyTeachingImage", type: "image", label: "Faculty Teaching Image" }]
        }]
      },
      {
        id: "academics", title: "Academics", sections: [{
          id: "education_overview", title: "Education Overview", endpoint: "academics", type: "singleton", path: "/education-overview", fields: [
            { key: "educationOverview", type: "object", label: "Overview", fields: [{ key: "description", type: "textarea", label: "Description" }, { key: "highlights", type: "string_array", label: "Highlights", fields: ["text"] }, { key: "bannerImage", type: "image", label: "Banner Image" }, { key: "editorialPhotos", type: "array", label: "Editorial Photos", fields: [{ key: "url", type: "image", label: "Image" }] }, { key: "infographicImage", type: "image", label: "Infographic Image" }] }]
        }, {
          id: "pedagogy_labs", title: "Pedagogy Labs", endpoint: "academics", type: "singleton", path: "/pedagogy-labs", fields: [
            { key: "pedagogyLabs", type: "object", label: "Labs Info", fields: [{ key: "introTitle", type: "text", label: "Intro Title" }, { key: "introDesc", type: "textarea", label: "Intro Description" }, { key: "introPoints", type: "string_array", label: "Intro Points", fields: ["text"] }, { key: "facilities", type: "array", label: "Facilities", fields: ["title", "description", "icon"] }, { key: "practiceTeachingDesc", type: "textarea", label: "Practice Teaching Description" }, { key: "equipmentWideImage", type: "image", label: "Equipment Wide Image" }, { key: "equipmentCloseups", type: "array", label: "Equipment Closeups", fields: [{ key: "url", type: "image", label: "Image" }] }, { key: "studentsWorkingImages", type: "array", label: "Students Working Images", fields: [{ key: "url", type: "image", label: "Image" }] }, { key: "safetySignageImage", type: "image", label: "Safety Signage Image" }, { key: "practiceTeachingImage", type: "image", label: "Practice Teaching Image" }] }]
        }, {
          id: "certificate_programs", title: "Certificate Programs", endpoint: "academics", type: "singleton", path: "/certificate-programs", fields: [
      ...
      },
      {
        id: "campus_life", title: "Campus Life", sections: [
          {
            id: "infrastructure", title: "Infrastructure", endpoint: "campuslife", type: "singleton", path: "/infrastructure", fields: [
          ...
          {
            id: "it_labs", title: "IT Labs", endpoint: "campuslife", type: "singleton", path: "/it-lab", fields: [
          ...
          {
            id: "library", title: "Library", endpoint: "campuslife", type: "singleton", path: "/library", fields: [
          ...
          {
            id: "auditorium", title: "Auditorium", endpoint: "campuslife", type: "singleton", path: "/auditorium", fields: [
          ...
          {
            id: "sports", title: "Sports", endpoint: "campuslife", type: "singleton", path: "/sports", fields: [
              { key: "sports", type: "object", label: "Facilities", fields: [{ key: "content", type: "textarea", label: "Content" }, { key: "specs", type: "array", label: "Specifications", fields: ["label", "value"] }, { key: "heroWideAngle", type: "image", label: "Hero Wide Angle" }, { key: "eventPhoto", type: "image", label: "Event Photo" }, { key: "entranceImage", type: "image", label: "Entrance Image" }, { key: "interiorDetails", type: "array", label: "Interior Details", fields: [{ key: "url", type: "image", label: "Image" }] }] }]
          },
          {
            id: "hostel", title: "Hostel", endpoint: "campuslife", type: "singleton", path: "/hostel", fields: [
          ...
          {
            id: "cultural", title: "Cultural Activities", endpoint: "campuslife", type: "singleton", path: "/cultural-activities", fields: [
          ...
          {
            id: "faculty", title: "Faculty Directory", endpoint: "campuslife", type: "singleton", path: "/faculty", fields: [
          ...
          {
            id: "visiting_faculty", title: "Visiting Faculty", endpoint: "campuslife", type: "singleton", path: "/visiting-faculty", fields: [
      ...
      },
      {
        id: "learning_activities", title: "Learning & Activities", sections: [
          {
            id: "calendar_events", title: "Events Calendar", endpoint: "learning", type: "singleton", path: "/events-calendar", fields: [
          ...
          {
            id: "skill_development", title: "Skill Development", endpoint: "learning", type: "singleton", path: "/skill-development", fields: [
          ...
          {
            id: "debates_gd", title: "Debates & GD", endpoint: "learning", type: "singleton", path: "/debates-gd", fields: [
          ...
          {
            id: "industrial_visits", title: "Industrial Visits", endpoint: "learning", type: "singleton", path: "/industrial-visits", fields: [
          ...
          {
            id: "guest_lectures", title: "Guest Lectures", endpoint: "learning", type: "singleton", path: "/guest-lectures", fields: [
      ...
      },
      {
        id: "student_zone", title: "Student Zone", sections: [
          {
            id: "downloads", title: "Downloads", endpoint: "studentzone", type: "singleton", path: "/downloads", fields: [
          ...
          {
            id: "past_papers", title: "Past Exam Papers", endpoint: "studentzone", type: "singleton", path: "/past-papers", fields: [
          ...
          {
            id: "code_of_conduct", title: "Code of Conduct", endpoint: "studentzone", type: "singleton", path: "/code-of-conduct", fields: [
          ...
          {
            id: "anti_ragging", title: "Anti-Ragging", endpoint: "studentzone", type: "singleton", path: "/anti-ragging", fields: [
          ...
          {
            id: "grievance_redressal", title: "Grievance Redressal", endpoint: "studentzone", type: "singleton", path: "/grievance-redressal", fields: [
          ...
          {
            id: "privacy_policy", title: "Privacy Policy", endpoint: "studentzone", type: "singleton", path: "/privacy-policy", fields: [
          ...
          // --- Redirections for DRY Principle (Navbar Mirror) ---
          {
            id: "sz_redir_news", title: "News & Events", endpoint: "", type: "singleton", fields: [], redirect: { targetPage: "news", targetSection: "news_list", message: "Manage News & Events in the dedicated News section." }
          },
          {
            id: "sz_redir_calendar", title: "Events Calendar", endpoint: "", type: "singleton", fields: [], redirect: { targetPage: "learning_activities", targetSection: "calendar_events", message: "Manage Events Calendar in Learning & Activities." }
          },
          {
            id: "sz_redir_skill", title: "Skill Development", endpoint: "", type: "singleton", fields: [], redirect: { targetPage: "learning_activities", targetSection: "skill_development", message: "Manage Skill Development in Learning & Activities." }
          },
          {
            id: "sz_redir_cultural", title: "Cultural & Kshitiz", endpoint: "", type: "singleton", fields: [], redirect: { targetPage: "campus_life", targetSection: "cultural", message: "Manage Cultural Activities in Campus Life." }
          },
          {
            id: "sz_redir_debates", title: "Debates & GD", endpoint: "", type: "singleton", fields: [], redirect: { targetPage: "learning_activities", targetSection: "debates_gd", message: "Manage Debates & GD in Learning & Activities." }
          },
          {
            id: "sz_redir_visits", title: "Industrial Visits", endpoint: "", type: "singleton", fields: [], redirect: { targetPage: "learning_activities", targetSection: "industrial_visits", message: "Manage Industrial Visits in Learning & Activities." }
          },
          {
            id: "sz_redir_guest", title: "Guest Lectures", endpoint: "", type: "singleton", fields: [], redirect: { targetPage: "learning_activities", targetSection: "guest_lectures", message: "Manage Guest Lectures in Learning & Activities." }
          },
          {
            id: "sz_redir_infra", title: "Infrastructure", endpoint: "", type: "singleton", fields: [], redirect: { targetPage: "campus_life", targetSection: "infrastructure", message: "Manage Infrastructure in Campus Life." }
          },
          {
            id: "sz_redir_it_lab", title: "IT Lab", endpoint: "", type: "singleton", fields: [], redirect: { targetPage: "campus_life", targetSection: "it_labs", message: "Manage IT Labs in Campus Life." }
          },
          {
            id: "sz_redir_library", title: "Library", endpoint: "", type: "singleton", fields: [], redirect: { targetPage: "campus_life", targetSection: "library", message: "Manage Library in Campus Life." }
          },
          {
            id: "sz_redir_auditorium", title: "Auditorium", endpoint: "", type: "singleton", fields: [], redirect: { targetPage: "campus_life", targetSection: "auditorium", message: "Manage Auditorium in Campus Life." }
          },
          {
            id: "sz_redir_hostel", title: "Hostel", endpoint: "", type: "singleton", fields: [], redirect: { targetPage: "campus_life", targetSection: "hostel", message: "Manage Hostel in Campus Life." }
          },
          {
            id: "sz_redir_sports", title: "Sports", endpoint: "", type: "singleton", fields: [], redirect: { targetPage: "campus_life", targetSection: "sports", message: "Manage Sports in Campus Life." }
          },
          {
            id: "sz_redir_photos", title: "Photo Gallery", endpoint: "", type: "singleton", fields: [], redirect: { targetPage: "gallery", targetSection: "photos", message: "Manage Photo Gallery in the dedicated Gallery section." }
          },
          {
            id: "sz_redir_videos", title: "Video Gallery", endpoint: "", type: "singleton", fields: [], redirect: { targetPage: "gallery", targetSection: "videos", message: "Manage Video Gallery in the dedicated Gallery section." }
          },
          {
            id: "sz_redir_press", title: "Press Coverage", endpoint: "", type: "singleton", fields: [], redirect: { targetPage: "gallery", targetSection: "press", message: "Manage Press Coverage in the dedicated Gallery section." }
          }
        ]
      },
      {
        id: "admissions", title: "Admissions", sections: [{
          id: "enquiry_page", title: "Enquiry Page", endpoint: "admissions", type: "singleton", fields: [
            { key: "enquiryPage", type: "object", label: "Enquiry Content", fields: [{ key: "introText", type: "textarea", label: "Intro Text" }, { key: "counsellingPoints", type: "array", label: "Counselling Points", fields: ["text"] }, { key: "onlinePortalText", type: "textarea", label: "Online Portal Text" }] }]
        }, {
          id: "how_to_apply", title: "How to Apply", endpoint: "admissions", type: "singleton", fields: [
            { key: "howToApply", type: "object", label: "Process", fields: [{ key: "highlight", type: "text", label: "Highlight Message" }, { key: "bannerImage", type: "image", label: "Banner Image" }, { key: "images", type: "array", label: "Orientation Photos", fields: [{ key: "url", type: "image", label: "Image" }] }, { key: "admissionProcess", type: "array", label: "Steps", fields: ["step", "desc"] }, { key: "documentChecklist", type: "string_array", label: "Required Documents", fields: ["text"] }, { key: "helpContact", type: "text", label: "Help Info" }] }]
        }, {
          id: "scholarships", title: "Scholarships", endpoint: "admissions", type: "singleton", fields: [
            { key: "scholarships", type: "array", label: "List", fields: ["category", "description"] }, { key: "scholarshipBanner", type: "image", label: "Scholarships Banner" }, { key: "scholarshipRecipientPhoto", type: "image", label: "Scholarship Recipient Photo" }]
        }, {
          id: "faqs", title: "FAQs", endpoint: "admissions", type: "singleton", fields: [
            { key: "faqs", type: "array", label: "List", fields: ["question", "answer"] }, { key: "faqsBanner", type: "image", label: "FAQs Banner" }]
        }]
      },
      {
        id: "placements", title: "Placements", sections: [{
          id: "placement_headings", title: "Page Headings", endpoint: "placements", type: "singleton", fields: [
            { key: "heading", type: "text", label: "Section Heading" }, { key: "subheading", type: "text", label: "Section Subheading" }, { key: "partnersHeading", type: "text", label: "Partners Subheading" }, { key: "statsInfographic", type: "image", label: "Stats Infographic Image" }, { key: "placementCeremonyImages", type: "array", label: "Placement Ceremony Images", fields: [{ key: "url", type: "image", label: "Image" }] }]
        }, {
          id: "numbers", title: "Placement Stats", endpoint: "placements", type: "singleton", fields: [
            { key: "stats", type: "array", label: "Stats", fields: ["label", "value", "description"] }]
        }, {
          id: "process", title: "Placement Process", endpoint: "placements", type: "singleton", fields: [
            { key: "process", type: "array", label: "Steps", fields: ["step", "desc"] }]
        }, {
          id: "partners", title: "Recruitment Partners", endpoint: "placements", type: "singleton", fields: [
            { key: "partners", type: "array", label: "Companies", fields: ["name", { key: "logo", type: "image", label: "Logo" }] }]
        }, {
          id: "stories", title: "Success Stories", endpoint: "placements", type: "singleton", fields: [
            { key: "studentSuccess", type: "array", label: "Alumni Feed", fields: ["name", "company", "feedback", "photo"] }]
        }, {
          id: "e_cell", title: "E-Cell, Internships & Alumni", endpoint: "placements", type: "singleton", fields: [
      ...
      },
      {
        id: "gallery", title: "Gallery", sections: [{
          id: "photos", title: "Photos", endpoint: "gallery", type: "singleton", fields: [
            { key: "photos", type: "array", label: "Image List", fields: ["title", { key: "url", type: "image", label: "Image" }] }]
        }, {
          id: "videos", title: "Videos", endpoint: "gallery", type: "singleton", fields: [
            { key: "videos", type: "array", label: "Video Links", fields: ["title", { key: "url", type: "image", label: "Image" }] }]
        }, {
          id: "press", title: "Press Coverage", endpoint: "gallery", type: "singleton", fields: [
      ...
      {
        id: "student_portal", title: "Student Portal", sections: [{
          id: "portal_info", title: "Portal Info", endpoint: "studentportal", type: "singleton", fields: [
      ...
      {
        id: "news", title: "News and Events", sections: [{
          id: "news_list", title: "News Listing", endpoint: "newsevents", type: "collection", fields: [
      ...
      {
        id: "fee_payment", title: "Fee Payment Portal", sections: [{
          id: "payment_info", title: "Payment Info", endpoint: "feepayment", type: "singleton", fields: [
  ...
  hospital: {
    ...
    pages: [
      ...
      { id: 'page_layout', title: '📐 Section Movement & Layout', sections: [] },
      { id: 'dynamic_pages', title: 'Custom Pages', sections: [] },
      {
        id: "homepage",
        title: "Homepage",
          ...
          },
          {
            ...
            fields: [
              ...
              { key: "accreditationsHeading", type: "text", label: "Section Heading (e.g. Accreditations & Approvals)" },
              {
                ...
                fields: [{ key: "image", type: "image", label: "Image" }, { key: "text", type: "text", label: "Accreditation Name" }]
              }
            ]
          }
        ]
        ...
        sections: [
          ...
          },
          {
            ...
            fields: [
              ...
              { key: "gallery", type: "array", label: "Image Gallery (4-8 images)", fields: [{ key: "image", type: "image", label: "Photo" }, { key: "caption", type: "text", label: "Caption (Optional)" }] },
        ...
        sections: [
          ...
          },
          {
            ...
            fields: [
              ...
              { key: "description", type: "textarea", label: "Description" },
              { key: "image", type: "image", label: "Cover Image" },
              { key: "gallery", type: "array", label: "Image Gallery (6-10 images)", fields: [{ key: "image", type: "image", label: "Photo" }, { key: "caption", type: "text", label: "Caption (Optional)" }] },
  ...
  legal: {
    ...
    pages: [
        ...
        sections: [
          {
            id: 'banner', title: 'Hero Banners', endpoint: 'homepage', type: 'singleton', fields: [
              { key: 'banners', type: 'array', label: 'Slides', fields: ['heading', 'subheading', { key: 'image', type: 'image', label: 'Image' }, 'ctaText', 'ctaLink', { key: 'cta2Text', type: 'text', label: 'CTA 2 Text' }, { key: 'cta2Link', type: 'text', label: 'CTA 2 Link' }] }]
          },
          {
      ...
      },
      {
        ...
        sections: [
          {
            id: 'aboutus', title: 'About Us Page', endpoint: 'aboutus', type: 'singleton', path: '/about', fields: [
          ...
          {
            id: 'principal_message', title: "Principal's Message", endpoint: 'aboutus', type: 'singleton', path: '/director-message', fields: [
          ...
          {
            id: 'mission_vision', title: 'Mission & Vision', endpoint: 'aboutus', type: 'singleton', path: '/mission-vision', fields: [
          ...
          {
            id: 'why_ishan_law', title: 'Why Choose Us', endpoint: 'aboutus', type: 'singleton', path: '/why-iimt', fields: [
          ...
          {
            id: 'faqs', title: 'FAQs', endpoint: 'faqs', type: 'collection', path: '/faqs', fields: [
              { key: 'question', type: 'text', label: 'Question' }, { key: 'answer', type: 'longtext', label: 'Answer' }]
          },
          {
            id: 'mandatory_disclosure', title: 'Mandatory Disclosure', endpoint: 'mandatorydisclosure', type: 'singleton', path: '/mandatory-disclosure', fields: [
              { key: 'title', type: 'text', label: 'Page Title' }, { key: 'subtitle', type: 'text', label: 'Page Subtitle' }, { key: 'bannerImage', type: 'image', label: 'Banner Image' }, { key: 'statement', type: 'longtext', label: 'PCI/BCI Compliance Statement' }, { key: 'disclosureItems', type: 'array', label: 'Disclosure Items', fields: ['category', { key: 'items', type: 'longtext', label: 'Items (newline separated)' }] }]
          },
          {
            id: 'anti_ragging', title: 'Anti-Ragging', endpoint: 'mandatorydisclosure', type: 'singleton', path: '/anti-ragging', fields: [
              { key: 'antiRagging', type: 'object', label: 'Anti-Ragging Config', fields: [{ key: 'title', type: 'text', label: 'Page Title' }, { key: 'subtitle', type: 'text', label: 'Page Subtitle' }, { key: 'bannerImage', type: 'image', label: 'Banner Image' }, 'helpline', { key: 'content', type: 'textarea', label: 'Overview Content' }, { key: 'image', type: 'image', label: 'Cover Image' }, { key: 'committeeText', type: 'textarea', label: 'Committee Text' }, { key: 'reportMethods', type: 'array', label: 'Report Methods', fields: ['method'] }, { key: 'pledgeTitle', type: 'text', label: 'Pledge Title' }, { key: 'pledgeText', type: 'textarea', label: 'Pledge Text' }] }]
          },
          {
            id: 'grievance_redressal', title: 'Grievance Redressal', endpoint: 'mandatorydisclosure', type: 'singleton', path: '/grievance-redressal', fields: [
              { key: 'grievanceRedressal', type: 'object', label: 'Grievance Redressal Config', fields: [{ key: 'title', type: 'text', label: 'Page Title' }, { key: 'subtitle', type: 'text', label: 'Page Subtitle' }, { key: 'bannerImage', type: 'image', label: 'Banner Image' }, { key: 'content', type: 'textarea', label: 'Overview Content' }, { key: 'image', type: 'image', label: 'Cover Image' }, 'portalLink', { key: 'process', type: 'array', label: 'Redressal Process', fields: ['step', { key: 'description', type: 'textarea', label: 'Description' }] }] }]
          },
          {
            id: 'code_of_conduct', title: 'Code of Conduct', endpoint: 'codeofconduct', type: 'singleton', path: '/code-of-conduct', fields: [
              { key: 'title', type: 'text', label: 'Page Title' }, { key: 'subtitle', type: 'text', label: 'Page Subtitle' }, { key: 'bannerImage', type: 'image', label: 'Banner Image' }, { key: 'intro', type: 'longtext', label: 'Introductory Statement' }, { key: 'image', type: 'image', label: 'Cover Image' }, { key: 'rules', type: 'array', label: 'Rules Categories', fields: ['category', { key: 'items', type: 'longtext', label: 'Items (newline separated)' }] }]
          }
        ]
      },
      {
        ...
        sections: [
          {
            id: 'programs_overview', title: 'Programs Overview', endpoint: 'programsoverview', type: 'singleton', path: '/education-overview', fields: [
          ...
          {
            id: 'programs', title: 'Academic Programs', endpoint: 'programs', type: 'collection', path: '/courses', fields: [
          ...
          {
            id: 'certificate_overview', title: 'Certificate Overview', endpoint: 'certificateoverview', type: 'singleton', path: '/certificate-programs', fields: [
          ...
          {
            id: 'certificates', title: 'Certificate Programs', endpoint: 'certificates', type: 'collection', path: '/certificate-programs', fields: [
          ...
          {
            id: 'internship_externship', title: 'Internship & Externship', endpoint: 'internshipexternship', type: 'singleton', path: '/pedagogy-labs', fields: [
          ...
          {
            id: 'admissions', title: 'Admissions & Scholarships', endpoint: 'admissions', type: 'singleton', path: '/admissions', fields: [
              { key: 'howToApply', type: 'array', label: 'Admission Steps', fields: [{ key: 'num', type: 'text', label: 'Step Number' }, { key: 'title', type: 'text', label: 'Title' }, { key: 'desc', type: 'textarea', label: 'Description' }] }, { key: 'documents', type: 'array', label: 'Required Documents', fields: [{ key: 'docName', type: 'text', label: 'Document Name' }] }, { key: 'alertBanner', type: 'object', label: 'Alert Banner', fields: [{ key: 'title', type: 'text', label: 'Title' }, { key: 'content', type: 'textarea', label: 'Content' }, { key: 'isActive', type: 'boolean', label: 'Is Active?' }] }, { key: 'admissionContact', type: 'object', label: 'Admission Contact', fields: [{ key: 'phone', type: 'text', label: 'Phone' }, { key: 'email', type: 'text', label: 'Email' }] }, { key: 'scholarships', type: 'array', label: 'Scholarships', fields: [{ key: 'category', type: 'text', label: 'Category' }, { key: 'concession', type: 'text', label: 'Concession' }, { key: 'description', type: 'textarea', label: 'Description' }] }, { key: 'bannerImage', type: 'image', label: 'Admissions Banner' }, { key: 'orientationPhotos', type: 'array', label: 'Orientation Photos', fields: [{ key: 'url', type: 'image', label: 'Image' }, { key: 'caption', type: 'text', label: 'Caption' }] }, { key: 'scholarshipsBanner', type: 'image', label: 'Scholarships Cover Image' }, { key: 'scholarshipsHandoverPhotos', type: 'array', label: 'Scholarship Handover Photos', fields: [{ key: 'url', type: 'image', label: 'Image' }, { key: 'caption', type: 'text', label: 'Caption' }] }]
          },
          {
            id: 'feepayment', title: 'Fee Payment', endpoint: 'feepayment', type: 'singleton', path: '/fee-payment', fields: [
      ...
      },
      {
        ...
        sections: [
          {
            id: 'faculty', title: 'Faculty Directory', endpoint: 'faculty', type: 'collection', path: '/faculty', fields: [
              { key: 'name', type: 'text', label: 'Name' }, { key: 'designation', type: 'text', label: 'Designation' }, { key: 'qualification', type: 'text', label: 'Qualification' }, { key: 'specialisation', type: 'text', label: 'Specialization' }, { key: 'dept', type: 'text', label: 'Department' }, { key: 'bio', type: 'textarea', label: 'Bio' }, { key: 'publications', type: 'text', label: 'Publications count' }, { key: 'image', type: 'image', label: 'Photo' }]
          },
          {
            id: 'visitingfaculty', title: 'Visiting Faculty', endpoint: 'visitingfaculty', type: 'collection', path: '/visiting-faculty', fields: [
      ...
      campusLifePage(),
      {
        ...
        sections: [
          {
            id: 'facilities', title: 'Facilities & Labs', endpoint: 'facilities', type: 'collection', path: '/infrastructure', fields: [
              { key: 'slug', type: 'text', label: 'Page URL Slug' }, { key: 'title', type: 'text', label: 'Page Title' }, { key: 'subtitle', type: 'textarea', label: 'Page Subtitle' }, { key: 'overviewHeading', type: 'text', label: 'Overview Heading' }, { key: 'overviewContent', type: 'textarea', label: 'Overview Content' }, { key: 'image', type: 'image', label: 'Cover Image' }, { key: 'bannerImage', type: 'image', label: 'Banner Image' }, { key: 'editorialPhotos', type: 'array', label: 'Editorial Photos', fields: [{ key: 'url', type: 'image', label: 'Image' }] }, { key: 'images', type: 'array', label: 'Gallery Images', fields: [{ key: 'url', type: 'image', label: 'Image' }, { key: 'caption', type: 'text', label: 'Caption' }] }, { key: 'highlights', type: 'array', label: 'Highlights / Equipment', fields: ['title', 'description'] }]
          },
          {
            id: 'photos', title: 'Photo Gallery', endpoint: 'photos', type: 'collection', path: '/photo-gallery', fields: [
          ...
          {
            id: 'videos', title: 'Video Gallery', endpoint: 'videos', type: 'collection', path: '/video-gallery', fields: [
              { key: 'title', type: 'text', label: 'Video Title' }, { key: 'category', type: 'text', label: 'Category' }, { key: 'url', type: 'text', label: 'YouTube URL' }]
          },
          {
            id: 'press', title: 'Press Coverage', endpoint: 'press', type: 'collection', path: '/press-coverage', fields: [
      ...
      },
      {
        ...
        sections: [
          {
            id: 'mootcourt', title: 'Moot Court Sessions', endpoint: 'mootcourt', type: 'singleton', path: '/pedagogy-labs', fields: [
          ...
          {
            id: 'legalaidcell', title: 'Legal Aid & E-Cell', endpoint: 'legalaidcell', type: 'singleton', path: '/e-cell', fields: [
          ...
          {
            id: 'courtjailvisits', title: 'Court & Industrial Visits', endpoint: 'industrialvisits', type: 'collection', path: '/industrial-visits', fields: [
              { key: 'company', type: 'text', label: 'Court / Industry Name' }, { key: 'location', type: 'text', label: 'Location' }, { key: 'date', type: 'text', label: 'Date' }, { key: 'description', type: 'longtext', label: 'Description' }, { key: 'takeaways', type: 'longtext', label: 'Key Takeaways' }]
          },
          {
            id: 'skilldevelopment', title: 'Skill Development Cell', endpoint: 'skilldevelopment', type: 'singleton', path: '/skill-development', fields: [
      ...
      },
      {
        ...
        title: 'Events & Guest Lectures',
        sections: [
          {
            id: 'news', title: 'News & Events', endpoint: 'news', type: 'collection', path: '/news-events', fields: [
              { key: 'image', type: 'image', label: 'Cover' }, 'title', 'date', 'category', { key: 'description', type: 'textarea', label: 'Description' }, 'link']
          },
          {
            id: 'debatesgd', title: 'Debates & GD', endpoint: 'debatesgd', type: 'singleton', path: '/debates-gd', fields: [
              { key: 'title', type: 'text', label: 'Page Title' }, { key: 'subtitle', type: 'text', label: 'Page Subtitle' }, { key: 'content', type: 'longtext', label: 'Overview Content' }, { key: 'image', type: 'image', label: 'Cover Image' }, { key: 'bannerImage', type: 'image', label: 'Banner Image' }, { key: 'images', type: 'array', label: 'Photo Gallery', fields: [{ key: 'url', type: 'image', label: 'Image' }, { key: 'caption', type: 'text', label: 'Caption' }] }, { key: 'items', type: 'array', label: 'Activities', fields: ['title', { key: 'desc', type: 'longtext', label: 'Description' }, 'icon'] }]
          },
          {
            id: 'culturalactivities', title: 'Cultural Activities', endpoint: 'culturalactivities', type: 'singleton', path: '/cultural-activities', fields: [
          ...
          {
            id: 'guestlecturespage', title: 'Guest Lectures Page Header', endpoint: 'guestlecturespage', type: 'singleton', path: '/guest-lectures', fields: [
          ...
          {
            id: 'guestlectures', title: 'Guest Lectures (Individual Cards)', endpoint: 'guestlectures', type: 'collection', path: '/guest-lectures', fields: [
      ...
      },
      {
        ...
        sections: [
          // Academic Hub
          {
            id: 'downloads', title: 'Downloads', endpoint: 'downloads', type: 'singleton', path: '/downloads', fields: [
          ...
          {
            id: 'pastpapers', title: 'Past Exam Papers', endpoint: 'pastpapers', type: 'singleton', path: '/past-papers', fields: [
              { key: 'title', type: 'text', label: 'Title' }, { key: 'subtitle', type: 'text', label: 'Subtitle' }, { key: 'overview', type: 'textarea', label: 'Overview' }, { key: 'image', type: 'image', label: 'Cover Image' }, { key: 'files', type: 'array', label: 'Files', fields: ['name', 'fileType', 'category', 'size', { key: 'url', type: 'file', label: 'Upload PDF' }] }]
          },
          {
            id: 'codeofconduct', title: 'Code of Conduct', endpoint: 'codeofconduct', type: 'singleton', path: '/code-of-conduct', fields: [
          ...
          {
            id: 'studentportal', title: 'Student Portal', endpoint: 'studentportal', type: 'singleton', path: '/student-portal', fields: [
          ...
          {
            id: 'publications', title: 'Publications', endpoint: 'publications', type: 'collection', path: '/research-journal', fields: [
          ...
          {
            id: 'alumninetwork', title: 'Alumni Network', endpoint: 'alumninetwork', type: 'collection', path: '/e-cell', fields: [
      ...
      },
      {
        ...
        sections: [
          {
            id: 'research', title: 'Research Projects', endpoint: 'researchprojects', type: 'collection', path: '/research-journal', fields: [
          ...
          {
            id: 'careerspage', title: 'Careers Page Header', endpoint: 'careerspage', type: 'singleton', path: '/careers', fields: [
              { key: 'title', type: 'text', label: 'Page Title' }, { key: 'subtitle', type: 'text', label: 'Page Subtitle' }, { key: 'overview', type: 'textarea', label: 'Overview Content' }, { key: 'image', type: 'image', label: 'Cover Image' }]
          },
          {
            id: 'careers', title: 'Careers (Openings)', endpoint: 'careers', type: 'collection', path: '/careers', fields: [
          ...
          {
            id: 'contact', title: 'Contact Us', endpoint: 'contact', type: 'singleton', path: '/contact', fields: [
              { key: 'title', type: 'text', label: 'Page Title' }, { key: 'subtitle', type: 'text', label: 'Page Subtitle' }, { key: 'overview', type: 'textarea', label: 'Overview Content' }, { key: 'image', type: 'image', label: 'Cover Image' }, { key: 'bannerImage', type: 'image', label: 'Banner Image' }, { key: 'address', type: 'text', label: 'Address' }, { key: 'phone', type: 'text', label: 'Phone Number' }, { key: 'email', type: 'text', label: 'Email' }, { key: 'mapEmbed', type: 'text', label: 'Map Embed URL (iframe src)' }]
          },
          {
            id: 'feedbackpage', title: 'Feedback Page Header', endpoint: 'feedbackpage', type: 'singleton', path: '/feedback', fields: [
              { key: 'title', type: 'text', label: 'Page Title' }, { key: 'subtitle', type: 'text', label: 'Page Subtitle' }, { key: 'overview', type: 'textarea', label: 'Overview Content' }, { key: 'image', type: 'image', label: 'Cover Image' }]
          },
          {
            id: 'feedback', title: 'Feedback Submissions', endpoint: 'feedback', type: 'collection', path: '/feedback', fields: [
          ...
          {
            id: 'leads', title: 'Admission Leads', endpoint: 'leads', type: 'collection', path: '/admissions-enquiry', fields: [
              { key: 'name', type: 'text', label: 'Name' },
              { key: 'email', type: 'text', label: 'Email' },
              { key: 'phone', type: 'text', label: 'Phone' },
    ...
    pages: [
      ...
      },
      {
        ...
        sections: [
          {
            id: 'banner', title: 'Hero Banners', endpoint: 'homepage', type: 'singleton', fields: [
              { key: 'banners', type: 'array', label: 'Slides', fields: [{ key: 'badge', type: 'text', label: 'Top Badge (e.g. PCI APPROVED)' }, 'heading', 'subheading', { key: 'description', type: 'textarea', label: 'Description' }, { key: 'image', type: 'image', label: 'Image' }, 'ctaText', 'ctaLink', { key: 'cta2Text', type: 'text', label: 'CTA 2 Text' }, { key: 'cta2Link', type: 'text', label: 'CTA 2 Link' }] }]
          },
          {
            id: 'stats', title: 'Stats & Achievements', endpoint: 'homepage', type: 'singleton', fields: [
              { key: 'stats', type: 'array', label: 'Stats', fields: ['label', 'value', { key: 'icon', type: 'image', label: 'Icon' }] }]
          ...
          },
          {
            id: 'why_ishan', title: 'Why Ishan Pharmacy', endpoint: 'homepage', type: 'singleton', fields: [
              { key: 'whyIshanHeading', type: 'text', label: 'Section Heading' },
              { key: 'whyIshanDescription', type: 'textarea', label: 'Section Description' },
              { key: 'whyIshan', type: 'array', label: 'Features', fields: ['title', 'description', { key: 'icon', type: 'image', label: 'Icon' }] }]
          },
          {
            id: 'programs_section', title: 'Programs Config', endpoint: 'homepage', type: 'singleton', fields: [
              { key: 'programsSection', type: 'object', label: 'Section Info', fields: ['badge', 'heading', { key: 'description', type: 'textarea', label: 'Description' }] }]
          },
          {
            id: 'faculty_section', title: 'Faculty Config', endpoint: 'homepage', type: 'singleton', fields: [
              { key: 'facultySection', type: 'object', label: 'Section Info', fields: ['badge', 'heading', { key: 'description', type: 'textarea', label: 'Description' }] }]
          },
          {
            id: 'news_section', title: 'News Config', endpoint: 'homepage', type: 'singleton', fields: [
              { key: 'newsSection', type: 'object', label: 'Section Info', fields: ['badge', 'heading'] }]
          },
          {
            id: 'testimonials_section', title: 'Testimonials Config', endpoint: 'homepage', type: 'singleton', fields: [
              { key: 'testimonialsSection', type: 'object', label: 'Section Info', fields: ['badge', 'heading'] }]
          },
          {
            id: 'faqs_section', title: 'FAQs Config', endpoint: 'homepage', type: 'singleton', fields: [
              { key: 'faqsSection', type: 'object', label: 'Section Info', fields: ['badge', 'heading'] }]
          },
          {
            id: 'enquiry_section', title: 'Enquiry Config', endpoint: 'homepage', type: 'singleton', fields: [
              { key: 'enquirySection', type: 'object', label: 'Section Info', fields: ['badge', 'heading', { key: 'description', type: 'textarea', label: 'Description' }] }]
          },
          {
            id: 'placements_section', title: 'Placements Config', endpoint: 'homepage', type: 'singleton', fields: [
              { key: 'placements', type: 'object', label: 'Section Info', fields: ['heading', 'subheading', { key: 'stats', type: 'array', label: 'Stats', fields: ['label', 'value'] }] }]
          },
          {
            id: 'campus', title: 'Campus Experience', endpoint: 'homepage', type: 'singleton', fields: [
              { key: 'gallery', type: 'array', label: 'Gallery Images', fields: [{ key: 'image', type: 'image', label: 'Image' }] }]
        ...
        sections: [
          ...
          },
          {
            id: 'principal_message', title: "Principal's Message", endpoint: 'aboutus', type: 'singleton', fields: [
              { key: 'principalMessage', type: 'object', label: "Principal's Message", fields: ['name', 'designation', { key: 'message', type: 'longtext', label: 'Message' }, { key: 'image', type: 'image', label: 'Image' }, { key: 'bottomImage', type: 'image', label: 'Bottom Image' }] }]
          },
          {
          ...
          },
          {
            id: 'approvals', title: 'Approvals & Affiliations', endpoint: 'aboutus', type: 'singleton', fields: [
              { key: 'approvalsPage', type: 'object', label: 'Page Content', fields: ['badge', 'heading', { key: 'description', type: 'textarea', label: 'Description' }, { key: 'features', type: 'array', label: 'Top Cards (e.g. PCI, AKTU)', fields: ['title', { key: 'description', type: 'textarea', label: 'Description' }] }] },
              { key: 'approvals', type: 'array', label: 'Bottom Image Cards', fields: ['title', { key: 'description', type: 'longtext', label: 'Description' }, { key: 'logo', type: 'image', label: 'Logo' }] }]
          },
          {
            id: 'why_choose_us', title: 'Why Choose Us', endpoint: 'homepage', type: 'singleton', fields: [
              { key: 'whyIshanHeading', type: 'text', label: 'Section Heading' },
              { key: 'whyIshanContent', type: 'textarea', label: 'Section Content' },
              { key: 'whyIshan', type: 'array', label: 'Features', fields: ['title', 'description', { key: 'icon', type: 'image', label: 'Icon' }] }]
          },
          {
            id: 'faqs', title: 'FAQs', endpoint: 'faqs', type: 'collection', fields: [
          ...
          },
          {
            id: 'mandatory_disclosure', title: 'Mandatory Disclosure', endpoint: 'mandatorydisclosure', type: 'singleton', fields: [
              ...
              { key: 'disclosureItems', type: 'array', label: 'Disclosure Items', fields: ['category', 'items'] },
              { key: 'bannerImage', type: 'image', label: 'Banner Image' },
              { key: 'images', type: 'array', label: 'Gallery Images', fields: [{ key: 'url', type: 'image', label: 'Image URL' }] }]
          },
          {
            id: 'code_of_conduct', title: 'Code of Conduct', endpoint: 'codeofconduct', type: 'singleton', fields: [
              { key: 'title', type: 'text', label: 'Title' },
              ...
              { key: 'rules', type: 'array', label: 'Rules', fields: ['category', { key: 'items', type: 'textarea', label: 'Items' }] },
              { key: 'bannerImage', type: 'image', label: 'Banner Image' },
              { key: 'images', type: 'array', label: 'Gallery Images', fields: [{ key: 'url', type: 'image', label: 'Image URL' }] }]
          }
        ]
      ...
      // campusLifePage(),
      {
        ...
        sections: [
          {
            id: 'guestlectures', title: 'Guest Lectures', endpoint: 'guestlectures', type: 'singleton', fields: [
              { key: 'title', type: 'text', label: 'Page Title' },
              { key: 'subtitle', type: 'text', label: 'Page Subtitle' },
              { key: 'overviewHeading', type: 'text', label: 'Overview Heading' },
              { key: 'overviewContent', type: 'textarea', label: 'Overview Content' },
              { key: 'bannerImage', type: 'image', label: 'Banner Image' },
              { key: 'events', type: 'array', label: 'Guest Lectures List', fields: [
          ...
          {
            id: 'industrialvisits', title: 'Industrial Visits', endpoint: 'industrialvisits', type: 'singleton', fields: [
              { key: 'title', type: 'text', label: 'Page Title' },
              { key: 'subtitle', type: 'text', label: 'Page Subtitle' },
              { key: 'overviewHeading', type: 'text', label: 'Overview Heading' },
              { key: 'overviewContent', type: 'textarea', label: 'Overview Content' },
              { key: 'bannerImage', type: 'image', label: 'Banner Image' },
              { key: 'visits', type: 'array', label: 'Industrial Visits List', fields: [
          ...
          },
          {
            id: 'press', title: 'Press Coverage', endpoint: 'press', type: 'collection', fields: [
              { key: 'title', type: 'text', label: 'Headline / Title' }, { key: 'publication', type: 'text', label: 'Publication Name' }, { key: 'date', type: 'text', label: 'Date' }, { key: 'url', type: 'text', label: 'Article Link' }, { key: 'image', type: 'image', label: 'Cover Image' }]
          },
          {
            ...
            fields: [

              {
                key: "whySection", type: "object", label: "Why Section Headers", fields: [
                  ...
                  { key: "campusImage", type: "image", label: "Campus Image (Wide)" }
                ]
              },
              {
        ...
        sections: [
          ...
          },
          {
            ...
            fields: [
              ...
              { key: "groupHistory", type: "object", label: "Group History", fields: [{ key: "content", type: "textarea", label: "Content" }, { key: "timelineInfographic", type: "image", label: "Timeline Infographic (Single Image)" }, { key: "timelineImages", type: "array", label: "Timeline Infographics (Multiple Images)", fields: [{ key: "url", type: "image", label: "Image" }] }] }
            ]
          },
          {
            id: "chairman_message",
            ...
            fields: [

              {
                key: "bamsProgram", type: "object", label: "BAMS Program", fields: [
                  ...
                  { key: "bannerImage", type: "image", label: "Course Specific Banner Image" },
                  { key: "studentActivityImages", type: "array", label: "Student Activities Photos", fields: [{ key: "image", type: "image", label: "Image" }, { key: "caption", type: "text", label: "Caption" }] },
                  { key: "careerOutcomeImage", type: "image", label: "Placement/Career Outcome Image" },
                  { key: "facultyTeachingImage", type: "image", label: "Faculty Teaching Image" }
                ]
              }
            ]
          },
            ...
            fields: [

              {
                key: "scopeOfBams", type: "object", label: "Scope of BAMS", fields: [
                  ...
                  { key: "bannerImage", type: "image", label: "Wide Banner Image" },
                  { key: "editorialImages", type: "array", label: "Campus/Event Editorial Photos", fields: [{ key: "image", type: "image", label: "Image" }, { key: "caption", type: "text", label: "Caption" }] }
                ]
              }
            ]
          },
            ...
            fields: [

              {
                key: "admissionProcess", type: "object", label: "Admission Process", fields: [
                  ...
                  { key: "steps", type: "array", label: "Steps", fields: [{ key: "step", type: "text", label: "Step Number (e.g. 01)" }, { key: "icon", type: "text", label: "Lucide Icon Name" }, { key: "title", type: "text", label: "Title" }, { key: "desc", type: "textarea", label: "Description" }] },
                  ...
                  { key: "bannerImage", type: "image", label: "Admissions Banner Image" },
                  { key: "orientationPhotos", type: "array", label: "Orientation Photos", fields: [{ key: "image", type: "image", label: "Image" }, { key: "caption", type: "text", label: "Caption" }] },
                  { key: "counsellorImage", type: "image", label: "Counsellor Interaction Image" }
                ]
              }
            ]
          },
            ...
            fields: [

              {
                key: "scholarships", type: "object", label: "Scholarships", fields: [
                  ...
                  { key: "bannerImage", type: "image", label: "Banner Image (with Students)" },
                  { key: "certificateHandoverImages", type: "array", label: "Certificate Handover Photos", fields: [{ key: "image", type: "image", label: "Image" }, { key: "caption", type: "text", label: "Caption" }] }
                ]
              }
            ]
          },
        ...
        sections: [
          {
            ...
            fields: [
              ...
              { key: "equipmentWideImage", type: "image", label: "Equipment Wide-Angle Photo" },
              { key: "equipmentCloseups", type: "array", label: "Equipment Close-ups", fields: [{ key: "image", type: "image", label: "Image" }, { key: "caption", type: "text", label: "Caption" }] },
              { key: "studentsWorkingImages", type: "array", label: "Students/Clinicians Working Photos", fields: [{ key: "image", type: "image", label: "Image" }, { key: "caption", type: "text", label: "Caption" }] },
              { key: "safetySignageImage", type: "image", label: "Safety Signage Photo" }
            ]
          }
        ]
      },
            ...
            fields: [

              {
                key: "researchJournal", type: "object", label: "Research Journal", fields: [
                  ...
                  { key: "boardHeadshots", type: "array", label: "Board Headshots", fields: [{ key: "image", type: "image", label: "Image" }, { key: "name", type: "text", label: "Name" }] },
                  { key: "researchActivityImages", type: "array", label: "Research Activity Photos", fields: [{ key: "image", type: "image", label: "Image" }, { key: "caption", type: "text", label: "Caption" }] }
                ]
              }
            ]
          },
            ...
            fields: [

              {
                key: "placements", type: "object", label: "Placements", fields: [
                  ...
                  { key: "statsInfographic", type: "image", label: "Stats Infographic Image" },
                  { key: "placementCeremonyImages", type: "array", label: "Placement Ceremony Photos", fields: [{ key: "image", type: "image", label: "Image" }, { key: "caption", type: "text", label: "Caption" }] }
                ]
              }
            ]
          },
            ...
            fields: [

              {
                key: "careers", type: "object", label: "Careers", fields: [
                  ...
                  { key: "campusWorkplaceImages", type: "array", label: "Campus Workplace Photos", fields: [{ key: "image", type: "image", label: "Image" }, { key: "caption", type: "text", label: "Caption" }] },
                  { key: "facultyTeamPhoto", type: "image", label: "Faculty/Team Photo" }
                ]
              }
            ]
          },
            ...
            fields: [

              {
                key: "mainContact", type: "object", label: "Main Contact Info", fields: [
                  ...
                  { key: "buildingExteriors", type: "array", label: "Building Exterior Photos", fields: [{ key: "image", type: "image", label: "Image" }, { key: "caption", type: "text", label: "Caption" }] },
                  { key: "receptionInterior", type: "image", label: "Reception Interior Photo" }
                ]
              },
              {
