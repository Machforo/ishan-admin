...
const commonLandingSections: Section[] = [
  {
    id: "marquee", title: "0. Global Marquee", endpoint: "marquee", type: "singleton", fields: [
      { key: "text", type: "textarea", label: "Marquee Text" }
    ]
  },
  {
  ...
  },
  {
    id: "research", title: "6. Research", endpoint: "", type: "singleton", fields: [
      ...
      { key: "researchCards", type: "array", label: "Research Photos/Cards", fields: ["title", "tag", { key: "image", type: "image", label: "Image" }] }
    ]
  },
  {
  ...
  },
  {
    id: "news_events", title: "10. News and Events", endpoint: "", type: "singleton", fields: [
      { key: "news", type: "array", label: "Events", fields: ["date", "title", "description", { key: "image", type: "image", label: "Image" }] }
    ]
  },
  {
    id: "social_wall", title: "11. Ishan Social Wall", endpoint: "", type: "singleton", fields: [
      { key: "socialPosts", type: "array", label: "Social Posts", fields: ["caption", { key: "image", type: "image", label: "Image" }, "likes"] }
    ]
  },
  {
